...
/**
 * This class defines the attributes that must be passed when making a request on a service.
 *
 * @author Derk Norton
 * @param <T> The type of service response.
 */
public abstract class ServiceRequest<T extends SmartObject<T>> extends SmartObject<T> {
